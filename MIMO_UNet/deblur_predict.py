...
from utils.utils import count_parameters, judge_and_remove_module_dict, same_seed
...
def predict(model, args, device):
    ...
    for val_dataset_name in dataset_name:
        ...
        dataset = Test_Loader(
            data_path=dataset_path, crop_size=args.crop_size, ZeroToOne=False
        )
